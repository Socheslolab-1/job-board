<!DOCTYPE html>
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <body class="from-10% via-30% to-90% mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-100 via-sky-100 to-emerald-100 text-slate-700">
            ...
            @if (session('success'))
            <div role="alert"
                class="my-8 rounded-mb border-l-4 border-green-300 bg-green-100 p-4 text-green-700 opacity-75">
            ...
            @if (session('error'))
            <div role="alert"
                class="my-8 rounded-mb border-l-4 border-red-300 bg-red-100 p-4 text-red-700 opacity-75">
